<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center">
        <h5 class="text-uppercase"><?php echo e(trans('labels.pricing_plans')); ?></h5>
        <?php if(Auth::user()->type == '1'): ?>
            <a href="<?php echo e(URL::to('admin/plan/add')); ?>" class="btn btn-secondary px-2 d-flex"> <i
                    class="fa-regular fa-plus mx-1"></i><?php echo e(trans('labels.add')); ?> </a>
        <?php endif; ?>
    </div>

    <div class="row <?php echo e(Auth::user()->type == 1 ? 'sort_menu' : ''); ?>" id="carddetails"
        ...
        <?php if(count($allplan) > 0): ?>
            <?php $__currentLoopData = $allplan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plandata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mt-3" data-id="<?php echo e($plandata->id); ?>">
                    <?php
                        if (Auth::user()->type == 4) {
                    ...
                    ?>
                    <div
                        class="card border-0 box-shadow h-100 <?php echo e($plan_id == $plandata->id ? 'plan-card-active' : 'border-0'); ?> handle">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h5 class="text-secondary"><?php echo e($plandata->name); ?></h5>
                                <?php if(Auth::user()->type == 1): ?>
                                    <a tooltip="<?php echo e(trans('labels.move')); ?>"><i
                                            class="fa-light fa-up-down-left-right"></i></a>
                                <?php endif; ?>
                            </div>

                            <div class="my-4">
                                <h5 class="mb-2"><?php echo e(helper::currency_formate($plandata->price, '')); ?>
                            ...
                            <?php if(Auth::user()->type == '1'): ?>
                                <?php if($plandata->is_available == 1): ?>
                                    <a tooltip="<?php echo e(trans('labels.active')); ?>"
                                        ...
                                        class="btn btn-outline-success  btn-sm mt-2"><i class="fas fa-check"></i></a>
                                <?php elseif($plandata->is_available == 2): ?>
                                    <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                        ...
                                        class="btn btn-outline-danger btn-sm mt-2"><i class="fas fa-close mx-1"></i></a>
                                <?php endif; ?>
                                <a href="<?php echo e(URL::to('admin/plan/edit-' . $plandata->id)); ?>"
                                    class="btn btn-outline-info btn-sm mt-2" tooltip="<?php echo e(trans('labels.edit')); ?>"> <i
                                        class="fa-regular fa-pen-to-square"></i> </a>
                                <a href="javascript:void(0)" class="btn btn-outline-danger btn-sm mt-2"
                                        ...
                                        <?php if($plandata->price > 0): ?>
                                            ...
                                            <?php else: ?>
                                                <?php if(@$data['original']['plan_date'] > date('Y-m-d')): ?>
                                                    <small
                                                        class="text-dark d-block"><?php echo e(@$data['original']['plan_message']); ?>

                                                        : <span
                                                            class="text-success"><?php echo e($data['original']['plan_date'] != '' ? helper::date_format($data['original']['plan_date']) : ''); ?></span></small>
                                                <?php else: ?>
                                                    <small
                                                        class="text-dark d-block"><?php echo e(@$data['original']['plan_message']); ?>

                                                        : <span
                                                            class="text-danger"><?php echo e($data['original']['plan_date'] != '' ? helper::date_format($data['original']['plan_date']) : ''); ?></span></small>
                                                <?php endif; ?>
                                            <?php endif; ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/plan/plan.blade.php ENDPATH**/ ?>