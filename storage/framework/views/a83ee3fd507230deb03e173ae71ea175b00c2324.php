    ...
    <section class="storereview-sec mb-5">
        <div class="container">
            <div class="sec-header py-2 mb-3">
                <h4 class="sec-title"><?php echo e(trans('labels.testimonials')); ?></h4>
            </div>
                        ...
                        <div class="card h-100 bg-light rounded p-4">
                            <div class="card-body p-0">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="px-3">
                                        <h5 class="line-1 mb-1 review_title"><?php echo e($item->name); ?></h5>
                                        <p class="review_date fs-8"><?php echo e(helper::date_format($item->created_at)); ?></p>
                                    </div>
                                </div>
                                <?php
                                    $count = $item->star;
...
<?php endif; ?>
<?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/front/testimonial.blade.php ENDPATH**/ ?>