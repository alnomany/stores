...
<?php $__env->startSection('content'); ?>
    <?php if(Auth::user()->type == 1): ?>
        <div class="alert alert-warning" role="alert">
            <p><?php echo e(trans('labels.dont_use_double_qoute')); ?></p>
        </div>
    <?php endif; ?>

    <div class="row settings">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="text-uppercase"><?php echo e(trans('labels.language-settings')); ?></h5>
            <?php if(Auth::user()->type == 1): ?>
                <?php if(App\Models\SystemAddons::where('unique_identifier', 'language')->first() != null &&
                    ...
                    <div class="d-inline-flex">
                        <a href="<?php echo e(URL::to('/admin/language-settings/add')); ?>" class="btn btn-secondary px-2 d-flex">
        ...
        <?php if(Auth::user()->type == 1): ?>
            ...
            <div class="col-xl-9">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="dropdown">
                        <a class="btn btn-outline-info" tooltip="<?php echo e(trans('labels.edit')); ?>"
                        ...
                        <?php if(Strtolower($currantLang->name) != 'english'): ?>
                            <a class="btn btn-outline-danger" tooltip="<?php echo e(trans('labels.delete')); ?>"
                        ...
                        <?php else: ?>
                            <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                ...
                                class="btn btn-outline-danger"><i class="fas fa-close"></i></a>
                        <?php endif; ?>
                    </div>

                    <?php if(helper::available_language('')->count() > 1): ?>
                        <div>
                            <label for="language_default" class="form-label"><?php echo e(trans('labels.default_language')); ?></label>
                            <select name="language_default" class="form-select" id="language_default"
                                ...
                                <?php $__currentLoopData = helper::available_language(''); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="item"
                                        ...
                                        <?php if(Request()->code != null && Request()->code != ''): ?> data-value="<?php echo e(URL::to('admin/language-settings/' . Request()->code . '?lang=' . $item->code)); ?>">
                                 <?php else: ?>
                                 data-value="<?php echo e(URL::to('admin/language-settings/?lang=' . $item->code)); ?>"> <?php endif; ?>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                                        ...
                                                        class="btn btn-sm btn-outline-danger <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_language-settings', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>"><i
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/language/index.blade.php ENDPATH**/ ?>