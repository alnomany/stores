...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group text-end">
                                <a href="<?php echo e(URL::to('admin/store_categories')); ?>" class="btn btn-outline-danger"><?php echo e(trans('labels.cancel')); ?></a>
                                <button class="btn btn-secondary" <?php if(env('Environment') == 'sendbox'): ?> type="button"
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/store_categories/add.blade.php ENDPATH**/ ?>