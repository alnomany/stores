        ...
        <div class="have-project-contain row align-items-center justify-content-center">
            <div class="col-lg-5 overflow-hidden d-lg-block d-none">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo e(@helper::image_path(helper::landingsettings()->subscribe_image)); ?>" alt=""
                ...
                <div>
                    ...
                    <form action="<?php echo e(URL::to('/emailsubscribe')); ?>" method="post">
                        ...
                        <div class="mt-4 mb-sm-0 mb-3 d-flex gap-2 border-0 input-btn">
                            ...
                            <button type="submit"
                                class="btn-primary mx-0 rounded-2"><?php echo e(trans('landing.subscribe')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/landing/newslatter.blade.php ENDPATH**/ ?>