...
<head>
    ...
    <!-- magnific-popup -->
    <link rel="stylesheet"
        href="<?php echo e(url(env('ASSETPATHURL') . 'admin-assets/css/magnific/magnific-popup.min.css')); ?>">
</head>
...
<body>
    ...
    <main>
        <div class="wrapper">
                    ...
                    <div class="page-content">
                        <div class="container-fluid">
                            ...
                            <?php if(env('Environment') == 'sendbox'): ?>
                                <div class="icon-bar">
                                    <a class="btn btn-success btn-lg active" href="https://1.envato.market/Yg7YmB"
                                        target="_blank"><?php echo e(trans('labels.buynow')); ?>
            ...
            <!----- theme sidebar ----->
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="themelabel"
                aria-labelledby="offcanvasWithBothOptionsLabel">

                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">All theme</h5>
...
<?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/layout/default.blade.php ENDPATH**/ ?>