<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="text-uppercase"><?php echo e(trans('labels.purchase_plan')); ?></h5>
    </div>
    <div class="row">
        ...
        <div class="col-md-8 col-sm-6 mb-3 payments">
                ...
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <h5 class="card-title"><?php echo e(trans('labels.apply_coupon')); ?></h5>
                            <p class="text-secondary cursor-pointer <?php echo e(session()->has('discount_data') ? 'd-none' : ''); ?>"
                                ...
                                <?php echo e(trans('labels.select_promocode')); ?></p>
                        </div>
            ...
            <div class="card border-0 box-shadow mt-3">
                <div class="card-body">
                    ...
                    <h5 class="card-title mb-4"><?php echo e(trans('labels.payment_details')); ?></h5>
            ...
            <div class="card border-0 box-shadow mt-3">
                <div class="card-body">
                    <h5 class="card-title mb-4"><?php echo e(trans('labels.payment_methods')); ?></h5>
                    <div class="row">
                    ...
                    <div class="text-end">
                        ...
                        <?php if($paymentmethod->count() > 0): ?>
                            <button
                                <?php if(env('Environment') == 'sendbox'): ?> type="button" onclick="myFunction()" <?php else: ?> type="button" <?php endif; ?>
                                class="btn btn-secondary <?php echo e(env('Environment') == 'sendbox' ? '' : 'buy_now'); ?> ">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="modal fade" id="couponmodal" tabindex="-1" aria-labelledby="couponmodalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="couponmodalLabel"><?php echo e(trans('labels.coupons_offers')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center my-2">
                            <div class="coupon_codewrapper">
                                ...
                                <div class="coupon_couponcode">
                                    <span class="coupon_text"><?php echo e($coupon->offer_code); ?></span>
                                </div>
                            </div>
                            <span class="coupon_text"><?php echo e($coupon->offer_name); ?></span>
                            <button class="btn btn-outline-success"
                                onclick="copy('<?php echo e($coupon->offer_code); ?>')"><?php echo e(trans('labels.copy')); ?></button>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/plan/plan_payment.blade.php ENDPATH**/ ?>