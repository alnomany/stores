<?php echo helper::appdata($storeinfo->id)->whatsapp_widget; ?>
                ...
                <?php $__currentLoopData = helper::footer_features(@$storeinfo->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12 d-flex p-3 justify-content-center">
                        ...
                        <div class="free-content px-3">
                            <h6 class="fw-500 m-0"><?php echo e($feature->title); ?></h6>
...
<footer class="footer-sec2 bg-light d-none d-lg-block">
    <div class="container">
        ...
        <ul class="footer-menu mb-4 ">
            ...
            <li class="px-2"><a href="<?php echo e(URL::to($storeinfo->slug . '/aboutus')); ?>"><?php echo e(trans('labels.about_us')); ?></a>
            </li>|
            <li class="px-2"><a
                    href="<?php echo e(URL::to($storeinfo->slug . '/terms_condition')); ?>"><?php echo e(trans('labels.terms_condition')); ?></a>
            </li>|
            <li class="px-2"><a
                    href="<?php echo e(URL::to($storeinfo->slug . '/refund_policy')); ?>"><?php echo e(trans('labels.refund_policy')); ?></a>
            </li>|
...
<!-- back-to-top -->
<section id="back-to-top" class="<?php echo e(session()->get('direction') == 2 ? 'back-to-top-rtl' : 'back-to-top-ltr'); ?>">
    <a class="text-dark">
        ...
        <div class="modal-content">
            <div class="modal-body p-3 pro-modal">
                <div class="row gx-3">
                    ...
                    <div class="col-lg-6">
                        <div
                            class="card-body repsonsive-cart-modal p-0 <?php echo e(session()->get('direction') == 2 ? 'text-right' : 'text-left'); ?>">
                            ...
                            <p id="tax"
                                class="responcive-tax <?php echo e(session()->get('direction') == 2 ? 'text-right' : 'text-left'); ?>">
                            </p>
                            ...
                            <?php endif; ?>
                            <div
                                class="modal-dec p-0 mb25 <?php echo e(session()->get('direction') == 2 ? 'text-right' : 'text-left'); ?>">
                                <h6 class="d-none" id="product_description"><?php echo e(trans('labels.product_description')); ?>

                                </h6>
                                <p class="card-text text-muted fs-7" id="item_description"></p>
                            </div>

                            <div class="d-flex mb25 d-none  <?php echo e(session()->get('direction') == 2 ? 'text-right' : 'text-left'); ?>"
                                id="attachment-detail">
                                <h6><?php echo e(trans('labels.attachment')); ?> :</h6>
                                <span>
                                    <p class="card-text fs-7 mx-2" id="attachment"></p>
                                </span>
                            </div>
                            <div
                                class="woo_pr_color flex_inline_center mb-2 <?php echo e(session()->get('direction') == 2 ? 'text-right' : 'text-left'); ?>">
                            ...
                            <div class="woo_pr_color flex_inline_center mb-2">
                                <div
                                    class="woo_colors_list <?php echo e(session()->get('direction') == 2 ? 'text-right' : 'text-left'); ?>">
                                    <span id="extras"></span>
                                    <?php echo e($errors->login->first('extras')); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100 gap-2 m-0">
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                ...
                                <?php endif; ?>
                                <?php if(helper::appdata($storeinfo->id)->contact != '' && helper::appdata($storeinfo->id)->contact != null): ?>
                                ...
                                <?php else: ?>
                                    <?php if(App\Models\SystemAddons::where('unique_identifier', 'whatsapp_message')->first() != null &&
                                            App\Models\SystemAddons::where('unique_identifier', 'whatsapp_message')->first()->activated == 1): ?>
                                        <?php if(helper::appdata($storeinfo->id)->whatsapp_number != '' && helper::appdata($storeinfo->id)->whatsapp_number != null): ?>
                                            <a class="btn rounded-circle whatsapp-btn" id="enquiries"
                                                target="_blank"><i class="fa-brands fa-whatsapp"></i></a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                        ...
                        <div class="col-6 d-flex align-items-center justify-content-center gap-2">
                            <?php if(helper::appdata($storeinfo->id)->online_order == 1): ?>
                                <button class="btn btn-store-outline m-0 add-btn" onclick="AddtoCart('0')">
                                    <span class="px-1"><?php echo e(trans('labels.addcart')); ?></span>
                                </button>
        ...
        <div class="modal-content close-modal">
            <div class="modal-body">
                ...
                <h3 class="hidden-xs mt-5" style="text-align: center;">
                    <strong><?php echo e(trans('messages.store_close')); ?></strong>
                </h3>
            </div>
        </div>
    </div>
                ...
                <div class="chat-form">
                    ...
                    <form action="https://api.whatsapp.com/send" method="get" target="_blank"
                        ...
                        <input type="hidden" name="phone"
                            value="<?php echo e(helper::appdata($storeinfo->id)->whatsapp_number); ?>">
...
<script>
    var logedin = "<?php echo e(Auth::user() && Auth::user()->type == 3 ? 1 : 0); ?>"
    ...
    function addratting(itemid) {
        if (logedin == 1) {
            ...
            toastr.error("<?php echo e(trans('messages.review_login_message')); ?>");
        }
...
<script type="text/javascript">
    ...
    var reviewshow = 0;
    if ("<?php echo e(App\Models\SystemAddons::where('unique_identifier', 'customer_login')->first()); ?>" != null &&
        "<?php echo e(App\Models\SystemAddons::where('unique_identifier', 'customer_login')->first()->activated); ?>" == 1) {
        if (
            "<?php echo e(helper::appdata($storeinfo->id)->checkout_login_required && helper::appdata($storeinfo->id)->product_ratting_switch == 1); ?>"
        ) {
            reviewshow = 1;
        }
    }
    ...
    function currency_formate(price) {
       ...
       if ("<?php echo e(@helper::appdata($storeinfo->id)->currency_position); ?>" == "left") {
           ...
           if ("<?php echo e(helper::appdata($storeinfo->id)->decimal_separator); ?>" == 1) {
               return "<?php echo e(@helper::appdata($storeinfo->id)->currency); ?>" + parseFloat(price).toFixed(formate);
           }else{
              var newprice = "<?php echo e(@helper::appdata($storeinfo->id)->currency); ?>" + (parseFloat(price).toFixed(formate));
              newprice = newprice.replace('.',',');
              return newprice;
           }
       } else {
           if ("<?php echo e(helper::appdata($storeinfo->id)->decimal_separator); ?>" == 1) {
               return parseFloat(price).toFixed(formate) + "<?php echo e(@helper::appdata($storeinfo->id)->currency); ?>";
           }else{
              var newprice =  (parseFloat(price).toFixed(formate)) + "<?php echo e(@helper::appdata($storeinfo->id)->currency); ?>";
              newprice = newprice.replace('.',',');
              return newprice;
           }
       }
    ...
    function GetProductOverview(id) {
        var imagepath =
            "<?php echo e(url(env('ASSETPATHURL') . 'admin-assets/images/about/defaultimages/item-placeholder.png')); ?>";
        var sku = "<?php echo e(trans('labels.sku')); ?>";
        $('#preloader').show();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.ResponseData.tax != null && response.ResponseData.tax != "") {
                    $('#tax').html(
                        "<span class='text-muted fs-7'><?php echo e(trans('labels.exclusive_taxes')); ?></span>");
                } else {
                    $('#tax').html(
                        "<span class='text-muted fs-7'><?php echo e(trans('labels.inclusive_taxes')); ?></span>");
                }
                ...
                if (response.ResponseData.extras.length != 0) {
                    html += '<h5 class="extra-title"><?php echo e(trans('labels.extras')); ?></h5>';
                }
                ...
                if (response.ResponseData.variation.length != 0) {
                    ...
                    if (response.ResponseData.variation[0].is_available == 2) {
                        $('#not_available_text').html('(<?php echo e(trans('labels.not_available')); ?>)');
                        ...
                        if (response.ResponseData.variation[0].stock_management == 1) {
                            if (response.ResponseData.variation[0].qty > 0) {
                                ...
                                $('#out_of_stock').html('(<?php echo e(trans('labels.out_of_stock')); ?>)');
                            }
                        } else {
                            $('#out_of_stock').html('');
                        }
            ...
            success: function(response) {
                if (response.status == 1) {
                    if (buynow == 0) {
                        ...
                        location.href = "<?php echo e(URL::to($storeinfo->slug . '/checkout')); ?>";
                    }
...
<script>
    function showaddons(id, item_name, attribute, extra_name, extra_price, variation_name, variation_price) {
        ...
        if (variations != '') {
            html +=
                '<p class="fw-bolder m-0" id="variation_title"><?php echo e(trans('labels.variants')); ?> </p><ul class="m-0 ps-2">';
            for (i in variations) {
        ...
        if (extras != '') {
            ...
            html1 +=
                '<p class="fw-bolder m-0" id="extras_title"><?php echo e(trans('labels.extras')); ?> </p><ul class="m-0 ps-2">';
            for (i in extras) {
...
<?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/front/theme/footer.blade.php ENDPATH**/ ?>