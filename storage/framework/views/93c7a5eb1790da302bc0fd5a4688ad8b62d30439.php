                ...
                <?php else: ?>
                    <td>
                        <?php if($orderdata->status_type == '3'): ?>
                            <span
                                class="badge bg-success"><?php echo e(trans('labels.completed')); ?></span>
                        <?php elseif($orderdata->status_type == '4'): ?>
                            <span
                                class="badge bg-danger"><?php echo e(trans('labels.cancelled')); ?></span>
                        <?php else: ?>
                            --
                        <?php endif; ?>
                    </td>
                ...
                <td>
                    <?php if(Auth::user()->type == 2 || Auth::user()->type == 4): ?>
                        <a href="<?php echo e(URL::to('admin/orders/print/' . $orderdata->order_number)); ?>"
                            class="btn btn-outline-primary btn-sm" tooltip="<?php echo e(trans('labels.print')); ?>">
                    ...
                    <?php if(Auth::user()->type == 2 || Auth::user()->type == 4): ?>
                        <?php if(($orderdata->payment_type == 1 || $orderdata->payment_type == 6) && $orderdata->payment_status == 1 && $orderdata->status_type == 3 &&  $orderdata->status_type !=4): ?>
                            <a class="btn btn-sm btn-outline-secondary"
...
<?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/orders/orderstable.blade.php ENDPATH**/ ?>