...
<?php $__env->startSection('content'); ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <h5 class="text-uppercase"><?php echo e(trans('labels.store_categories')); ?></h5>

            <a href="<?php echo e(URL::to('admin/store_categories/add')); ?>" class="btn btn-secondary px-2 d-flex"><i
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/store_categories/index.blade.php ENDPATH**/ ?>