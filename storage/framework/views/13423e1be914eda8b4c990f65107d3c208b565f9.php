...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <h5 class="text-uppercase"><?php echo e(trans('labels.global_extras')); ?></h5>

        <a href="<?php echo e(URL::to('admin/extras/add')); ?>"
            class="btn btn-secondary px-2 d-flex <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>"><i
                        ...
                        <table class="table table-striped table-bordered py-3 zero-configuration w-100">
                            ...
                            <tbody id="tabledetails" data-url="<?php echo e(url('admin/extras/reorder_extras')); ?>">
                                ...
                                <?php $__currentLoopData = $allextras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extras): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="fs-7 row1" id="dataid<?php echo e($extras->id); ?>" data-id="<?php echo e($extras->id); ?>">
                                        ...
                                        <td>
                                            <?php if($extras->is_available == '1'): ?>
                                                <a tooltip="<?php echo e(trans('labels.active')); ?>"
                                                    ...
                                                    class="btn btn-sm btn-outline-success <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>"><i
                                            ...
                                            <?php else: ?>
                                                <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                                    ...
                                                    class="btn btn-sm btn-outline-danger <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>"><i
                                        ...
                                        <td>
                                            <a href="<?php echo e(URL::to('admin/extras/edit-' . $extras->id)); ?>"
                                                ...
                                                class="btn btn-outline-info btn-sm <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>">
                                            ...
                                            <a tooltip="<?php echo e(trans('labels.delete')); ?>"
                                                ...
                                                class="btn btn-outline-danger btn-sm <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, $vendor_id, 'delete') == 1 ? '' : 'd-none') : ''); ?>">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp81\htdocs\store-mart\resources\views/admin/extras/index.blade.php ENDPATH**/ ?>